...
1. E-step: Minimize $J$ with respect to $r_{ni}$, $i=1,\dots,K$:
$$
r_{ni} =
\begin{cases}
...
\end{cases}
$$
2. Given $r_{ni}$ minimize $J$ with respect to $\mu_k$,
$$
